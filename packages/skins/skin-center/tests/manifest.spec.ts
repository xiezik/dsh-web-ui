...
const WITH_QQ2006 = STOCK.replace(
  '</script>',
  ',{"id":"ui-skin-qq2006","url":"/plugins/@linxin666/dsh-client-ui-skin-qq2006/client.js?rev=def"}</script>',
)
